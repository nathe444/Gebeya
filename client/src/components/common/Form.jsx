...
const CommonForm = ({ formControls , formData , setFormData, onSubmit ,buttonText, Disabled}) => {
    ...
    return (
        <form onSubmit = {onSubmit}>
            ...
            <Button type='submit' disabled={Disabled} className='w-full mt-2'>{buttonText || 'Submit'}</Button>
        </form>
    )
}
